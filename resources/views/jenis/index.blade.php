    ...
    <div class="card">
        ...
        <strong><h3>Data Jenis Bantuan</h3></strong>
        <a href="{{ url('jenis/create') }}" class="btn btn-primary mb-3 float-end"><i class="bi bi-plus"></i> Tambah Baru</a>
